...
return array(
    ...
    '_TEMPLATE_NOT_EXIST_'   => '模板文件不存在',
    '_LAYOUT_NOT_EXIST_'     => '布局文件不存在',
    '_MODULE_'               => '模块',
    '_ACTION_'               => '操作',
    ...
    '_NOT_ALLOW_FUNCTION_'   => '不能使用模板禁用函数',
    '_PARAM_ERROR_'          => '参数错误或者未定义',
    '_ERROR_QUERY_EXPRESS_'  => '错误的查询条件',
    '_NO_UPDATA_EXPRESS_'    => '没有更新条件',
    '_ERROR_UPDATA_KEY_'     => '错误的复合主键条件',
    '_NO_UPDATA_KEY_'        => '缺少复合主键条件',
    '_NO_DELETE_EXPRESS_'    => '没有删除条件',
    '_STORAGE_WRITE_ERROR_'  => '文件写入失败',
    '_SQL_ERROR_'            => 'SQL ERROR',
);
