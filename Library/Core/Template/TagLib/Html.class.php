...
// +----------------------------------------------------------------------
namespace Core\Template\TagLib;
use Core\Template\TagLib;
/**
 * Html标签库驱动
 */
class Html extends TagLib {
    ...
    protected $tags   =  array(
        'php2'       =>  array('alias'=>'xiak'),
        'test2'       =>  array('attr'=>'name','alias'=>'t'),
        'x'       =>  array('attr'=>'name,key','alias'=>'sd,sd,sd', 'close'=>0, 'must' => 'name'),
    ...
    public function _php2($tag,$content) {
        $parseStr = '<?php '.$content.' ?>';
        return $parseStr;
    }


    public function _test2($attr, $content) {
        /*$parseStr = '<?php '.$attr['name'].$content.' ?>';*/
        $parseStr = $attr['name'].$content.'';
        return $parseStr;
    }


    public function _x($attr) {
        return $attr['name'];
    }


    public function _x2($tag,$content) {
        return '沈芳我永远爱你';
    }
