 ...
 *  update：2015-2-22 19:29:07
 *  by：http://www.thinkphp.cn/info/203.html
 */
class IpLocation {
    /**
     * qqwry.dat文件指针
    ...
    public function getlocation($ip='') {
        ...
        if (mb_detect_encoding($location['country'], array('GBK','GB2312','UTF-8')) == 'GBK') {
            call_user_func('iconv', 'gbk', 'utf-8', &$location['country']);
            call_user_func('iconv', 'gbk', 'utf-8', &$location['area']);
        }
